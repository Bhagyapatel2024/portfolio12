...
//     { title: "Frontend Projects", projects: frontendProjects },
//     { title: "Full Stack Projects", projects: fullStackProjects },
//     { title: "Machine Learning ", projects: machineLearningProjects },
//     // { title: "LLM and NLP Projects", projects: llmNlpProjects },
//   ];
...
//     {/* Flex Container for Project Categories */}
//     <div className="flex flex-wrap justify-center gap-12">
//       {projectCategories.map((category, catIndex) => (
//         <div
//           key={catIndex}
//           className="flex flex-col items-center text-center bg-black p-6 rounded-lg shadow-md max-w-[400px] flex-1"
//         >
//           {/* Category Title */}
//           <h3 className="text-3xl font-semibold text-white mb-6">{category.title}</h3>

//           {/* Grey MacBook Wrapper */}
//           <div
//             className="relative w-[250px] h-[150px] mb-8 "
//             style={{
//               perspective: "1000px",
//             }}
//           >
...
//               {/* Screen Area */}
//               <div
//                 className="relative w-full h-full bg-black rounded-md"
//                 style={{
//                   overflow: "hidden",
...
//                 <img
//                   src={category.projects[currentIndexes[catIndex]].image}
//                   alt={category.projects[currentIndexes[catIndex]].title}
...
//           {/* Project Details */}
//           <div
//             className="bg-black p-4 rounded-lg shadow-lg w-full"
//             style={{
...
//               {category.projects[currentIndexes[catIndex]].tags.map((tag, index) => (
//                 <span
//                   key={index}
...
//               {category.projects[currentIndexes[catIndex]].github && (
//                 <a
//                   href={category.projects[currentIndexes[catIndex]].github}
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="text-gray-400 hover:text-white transition-colors"
//                 >
...
//               {category.projects[currentIndexes[catIndex]].live && (
//                 <a
//                   href={category.projects[currentIndexes[catIndex]].live}
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="text-gray-400 hover:text-white transition-colors"
//                 >
...
//               <button
//                 onClick={() => handlePrev(catIndex)}
//                 className="bg-gray-800 text-white px-4 py-2 rounded-full shadow-md hover:bg-gray-600 transition-transform transform hover:scale-110"
//               >
//                 &#8592; Prev
//               </button>
//             )}
